...
{
    public class SL24_DC30_DGS_Check
    {
        ...
        {
            double[] MeasDC30_SL24_DGS1, MeasDC30_SL24_DGS2, MeasDC30_SL24_DGS3, MeasDC30_SL24_DGS4;
            ...
            DCPower SL24_DC30 = InstrCtrl.DCPowerPinsToSessions(tsmContext, "SL24_DC30");
            ...
            SL24_DC30.ConfigureSense(sense: DCPowerMeasurementSense.Remote, initiateSessionAfter: false);
            ...
            try
            {
                SL24_DC30.ForceCurrent(currentLevel: 1e-3, voltageLimit: 10); // force current on 1Kohm resistor
                ...
                HMODControl.HMOD5to10(tsmContext,
                    HMOD_Data_9: HMODControl.RelayID("K6, K7, K8, K9, K10, K11, K12, K13, K14, K15, K21, K22, K23, K24, K25"),
                    HMOD_Data_10: HMODControl.RelayID("K9, K10, K11, K27, K28"));

                HMODControl.CHMOD1to6(tsmContext, HMOD_Data_1: HMODControl.RelayID("K9")); // connect SL10 DGS1 to 1V reference
                ...
                // HMOD8 - 0000 1100 0000 0000 0000 0111 0000 0000 = 201328384
                HMODControl.HMOD5to10(tsmContext,
                    HMOD_Data_9: HMODControl.RelayID("K1, K2, K3, K4, K5, K16, K17, K18, K19, K20, K26, K27, K28, K29, K30"),
                    HMOD_Data_10: HMODControl.RelayID("K9, K10, K11, K27, K28"));

                // Measure voltage, expected to be +1V - 2V(DGS = 2V REF) = -1V
                HMODControl.CHMOD1to6(tsmContext, HMOD_Data_1: HMODControl.RelayID("K10")); // connect SL10 DGS2 to 2V reference
                Globals.TheHdw.Wait(SettlingTimeSec);
                ...
                HMODControl.HMOD5to10(tsmContext,
                    HMOD_Data_9: HMODControl.RelayID("K1, K2, K3, K4, K5, K21, K22, K23, K24, K25, K31, K32"),
                    HMOD_Data_10: HMODControl.RelayID("K1, K2, K3, K4, K5, K6, K7, K8, K12, K13, K27, K28"));

                // Measure voltage, expected to be +1V - 3V(DGS = 3V REF) = -2V
                HMODControl.CHMOD1to6(tsmContext, HMOD_Data_1: HMODControl.RelayID("K11")); // connect SL10 DGS3 to 3V reference
                Globals.TheHdw.Wait(SettlingTimeSec);
                ...
                HMODControl.HMOD5to10(tsmContext,
                    HMOD_Data_9: HMODControl.RelayID("K1, K2, K3, K4, K5, K21, K22, K23, K24, K25"),
                    HMOD_Data_10: HMODControl.RelayID("K9, K10, K11, K14, K15, K16, K17, K18, K19, K20, K21, K22, K23, K24, K25, K26"));

                // Measure voltage, expected to be +1V - 4V(DGS = 4V REF) = -3V
                HMODControl.CHMOD1to6(tsmContext, HMOD_Data_1: HMODControl.RelayID("K12")); // connect SL10 DGS4 to 4V reference
                Globals.TheHdw.Wait(SettlingTimeSec);
            ...
            {
                SL24_DC30.ForceCurrent(currentLevel: 0, voltageLimit: 24);

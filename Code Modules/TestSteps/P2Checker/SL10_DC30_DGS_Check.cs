...
namespace TestSteps.P2Checker
{
    public class SL10_DC30_DGS_Check
    {
        ...
        public static void SL10DGSCheck(ISemiconductorModuleContext tsmContext)
        {
            ...
            SL10_DC30.ConfigureSense(sense: DCPowerMeasurementSense.Remote, initiateSessionAfter: false);
            ...
            try
            {
                SL10_DC30.ForceCurrent(currentLevel: 1e-3, voltageLimit: 10); // force current on 1Kohm resistor
                ...
                HMODControl.CHMOD1to6(tsmContext, HMOD_Data_1: HMODControl.RelayID("K5")); // connect SL10 DGS1 to 1V reference
                ...
                HMODControl.CHMOD1to6(tsmContext, HMOD_Data_1: HMODControl.RelayID("K6")); // connect SL10 DGS2 to 2V reference
                Globals.TheHdw.Wait(SettlingTimeSec);
                ...
                HMODControl.CHMOD1to6(tsmContext, HMOD_Data_1: HMODControl.RelayID("K7")); // connect SL10 DGS3 to 3V reference
                Globals.TheHdw.Wait(SettlingTimeSec);
                ...
                HMODControl.CHMOD1to6(tsmContext, HMOD_Data_1: HMODControl.RelayID("K8")); // connect SL10 DGS4 to 4V reference
                Globals.TheHdw.Wait(SettlingTimeSec);

...
namespace TestSteps
{
    public class vil_vih_2p25_2p25_pd
    {
        public static void Main(ISemiconductorModuleContext tsmContext, Pattern ThePat, PinList InPins, PinList OutPins, double VDD1_value, double idd1_value, double VDD2_value, double idd2_value)
        {
            ...
            thehdw.DCVI.Pins("VDD1").SetVoltageAndRange(VDD1_value, 10);    // 2.250 VDD1 2p25/2p25
            ...
            thehdw.DCVI.Pins("VDD2").SetVoltageAndRange(VDD2_value, 10); // 2.250 VDD2 2p25 / 2p25

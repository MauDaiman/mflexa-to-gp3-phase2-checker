...
namespace TestSteps
{
    class vil_vih_1p7_1p7_pd
    {
        public static void Main(ISemiconductorModuleContext tsmContext, string ThePat, PinList InPins, PinList OutPins, double VDD1_value, double idd1_value, double VDD2_value, double idd2_value)
        {
            ...
            thehdw.DCVI.Pins("VDD1").SetVoltageAndRange(VDD1_value, 10);    // 1.700 VDD1 1p7/1p7
            ...
            thehdw.DCVI.Pins("VDD2").SetVoltageAndRange(VDD2_value, 10);    // 1.700 VDD2 1p7/1p7

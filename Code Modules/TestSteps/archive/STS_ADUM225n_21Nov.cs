...
namespace TestSteps
{
	class TestProgram
	{
		...
		//Return True if not empty, else False.n;		
		...
		public static void DcviSupplyStatic(Pattern ThePat, double VDD1_value, double idd1_value, double VDD2_value, double idd2_value, PinList PrebodyUtil1Pins, PinList PrebodyUtil0Pins, PinList PostbodyUtil1Pins, PinList PostbodyUtil0Pins, bool do_ipat)
		{
			...
			else if (Globals.TheExec.CurrentJob == "ADuM225_char")
			{
				...
				{*/
					//OriginalCode: TheExec.Flow.TestLimit resultval:=IDD_VDD1_high_1p9_1p9, ScaleType:=scaleMilli, unit:=unitAmp, ForceResults:=tlForceFlow;
					//PseudoCode  : AsIsLineOfCode: LineOfCode: TheExec.Flow.TestLimit(resultval:=IDD_VDD1_high_1p9_1p9, ScaleType:=scaleMilli, unit:=unitAmp, ForceResults:=tlForceFlow);
					Globals.TheExec.Flow.TestLimit(resultval: IDD_VDD1_high_1p9_1p9, ScaleType: Globals.scaleMilli, unit: Globals.unitAmp, TName: Globals.TNames[0], ForceResults: Globals.tlForceFlow);

					//OriginalCode: TheExec.Flow.TestLimit resultval:=IDD_VDD2_high_1p9_1p9, ScaleType:=scaleMilli, unit:=unitAmp, ForceResults:=tlForceFlow;
					//PseudoCode  : AsIsLineOfCode: LineOfCode: TheExec.Flow.TestLimit(resultval:=IDD_VDD2_high_1p9_1p9, ScaleType:=scaleMilli, unit:=unitAmp, ForceResults:=tlForceFlow);
					Globals.TheExec.Flow.TestLimit(resultval: IDD_VDD2_high_1p9_1p9, ScaleType: Globals.scaleMilli, unit: Globals.unitAmp, TName: Globals.TNames[1], ForceResults: Globals.tlForceFlow);

					//OriginalCode: TheExec.Flow.TestLimit resultval:=IDD_VDD1_low_1p9_1p9, ScaleType:=scaleMilli, unit:=unitAmp, ForceResults:=tlForceFlow;
					//PseudoCode  : AsIsLineOfCode: LineOfCode: TheExec.Flow.TestLimit(resultval:=IDD_VDD1_low_1p9_1p9, ScaleType:=scaleMilli, unit:=unitAmp, ForceResults:=tlForceFlow);
					Globals.TheExec.Flow.TestLimit(resultval: IDD_VDD1_low_1p9_1p9, ScaleType: Globals.scaleMilli, unit: Globals.unitAmp, TName: Globals.TNames[2], ForceResults: Globals.tlForceFlow);

					//OriginalCode: TheExec.Flow.TestLimit resultval:=IDD_VDD2_low_1p9_1p9, ScaleType:=scaleMilli, unit:=unitAmp, ForceResults:=tlForceFlow;
					//PseudoCode  : AsIsLineOfCode: LineOfCode: TheExec.Flow.TestLimit(resultval:=IDD_VDD2_low_1p9_1p9, ScaleType:=scaleMilli, unit:=unitAmp, ForceResults:=tlForceFlow);
					Globals.TheExec.Flow.TestLimit(resultval: IDD_VDD2_low_1p9_1p9, ScaleType: Globals.scaleMilli, unit: Globals.unitAmp, TName: Globals.TNames[3], ForceResults: Globals.tlForceFlow);
		...
		public static void PulseWidthDistortion(PinList TestPins, PinList PrebodyUtil1Pins, PinList PrebodyUtil0Pins, PinList PostbodyUtil1Pins, PinList PostbodyUtil0Pins)
		{
			...
			/*//debug purposes only
			Globals.PropDelayRise = new SiteDouble[4]
			{
				new SiteDouble(Globals.tsmContext.SiteNumbers.Count(), 1) { [0] = 1.0 },
				new SiteDouble(Globals.tsmContext.SiteNumbers.Count(), 1) { [0] = 2.0 },
				new SiteDouble(Globals.tsmContext.SiteNumbers.Count(), 1) { [0] = 3.0 },
				new SiteDouble(Globals.tsmContext.SiteNumbers.Count(), 1) { [0] = 4.0 }
			};
			Globals.PropDelayFall = new SiteDouble[4]
			{
				new SiteDouble(Globals.tsmContext.SiteNumbers.Count(), 1) { [0] = 1.0 },
				new SiteDouble(Globals.tsmContext.SiteNumbers.Count(), 1) { [0] = 2.0 },
				new SiteDouble(Globals.tsmContext.SiteNumbers.Count(), 1) { [0] = 3.0 },
			...
			//remove the codes above after propdelay code is done*/
			...
			for (i = 0; i <= GlobalFunctions.UBound(TestPinsArray); i = i + 1)
			{
				...
				Globals.TheExec.Flow.TestLimit(resultval: Globals.PropDelayRise[i].Subtract(Globals.PropDelayFall[i]), ScaleType: Globals.scaleNano, unit: Globals.unitTime, TName: Globals.TNames[i] ,ForceResults: Globals.tlForceFlow);
		...
		public static void continuity_pd(PinList TestPins)
		{
			...
			//Globals.TheHdw.DCVI.Pins("VDD1").SetCurrentAndRange(0.1, 0.1);//4162 only support upto 100mA
			...
			Globals.TheExec.Flow.TestLimit(resultval: pos_diode, ScaleType: Globals.scaleNoScaling, unit: Globals.unitVolt, TName: Globals.TNames[0], ForceResults: Globals.tlForceFlow);
			...
			Globals.TheExec.Flow.TestLimit(resultval: neg_diode, ScaleType: Globals.scaleNoScaling, unit: Globals.unitVolt, TName: Globals.TNames[1], ForceResults: Globals.tlForceFlow);
		...
		public static void input_output_levels_1p7_1p7_pd()
		{
			...
			Globals.TheHdw.Digital.DisconnectPins("VOB,VOA");//TheHdw.Digital.DisconnectPins ("VOB_dc30_da, VOA_dc30_da");

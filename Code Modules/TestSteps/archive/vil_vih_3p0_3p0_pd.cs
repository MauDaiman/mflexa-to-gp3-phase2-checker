...
namespace TestSteps
{
    public class vil_vih_3p0_3p0_pd
    {
        public static void Main(ISemiconductorModuleContext tsmContext, Pattern ThePat, PinList InPins, PinList OutPins, double VDD1_value, double idd1_value, double VDD2_value, double idd2_value)
        {
            ...
            thehdw.DCVI.Pins("VDD1").SetVoltageAndRange(VDD1_value, 10);    // 3.000 VDD1 3p0/3p0
            ...
            thehdw.DCVI.Pins("VDD2").SetVoltageAndRange(VDD2_value, 10); // 3.000 VDD2 3p0/3p0

...
namespace TestSteps
{
    public class input_output_levels_4p5_4p5_pd
    {
        public static void Main(ISemiconductorModuleContext tsmContext, PinList TestPins)
        {
            ...
            thehdw.DCVI.Pins("VDD1").SetVoltageAndRange(4.5, 10);    //'VDD1 4p5/4p5
            ...
            thehdw.DCVI.Pins("VDD2").SetVoltageAndRange(4.5, 10);    //'VDD2 4p5/4p5

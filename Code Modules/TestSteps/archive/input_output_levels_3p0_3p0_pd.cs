...
namespace TestSteps
{
    public class input_output_levels_3p0_3p0_pd
    {
        public static void Main(ISemiconductorModuleContext tsmContext, PinList TestPins)
        {
            ...
            thehdw.DCVI.Pins("VDD1").SetVoltageAndRange(3.0, 10);    //'VDD1 4p5/4p5
            ...
            thehdw.DCVI.Pins("VDD2").SetVoltageAndRange(3.0, 10);    //'VDD2 4p5/4p5

...
namespace TestSteps
{
    public class input_output_levels_2p25_2p25_pd
    {
        public static void Main(ISemiconductorModuleContext tsmContext, PinList TestPins)
        {
            ...
            thehdw.DCVI.Pins("VDD1").SetVoltageAndRange(2.25, 10);    //'VDD1 4p5/4p5
            ...
            thehdw.DCVI.Pins("VDD2").SetVoltageAndRange(2.25, 10);    //'VDD2 4p5/4p5
            ...
            thehdw.Wait(0.001);
            VOL_20uA = thehdw.DCVI.Pins("VOA_dc30_da, VOB_dc30_da").Meter.Read(tlStrobe, 10, 10000, tlDCVIMeterReadingFormatAverage);

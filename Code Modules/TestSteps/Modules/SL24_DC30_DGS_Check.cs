...
namespace TestSteps.Modules
{
    public class SL24_DC30_DGS_Check
    {
        ...
        public static void SL24DGSCheck(ISemiconductorModuleContext tsmContext)
        {
            ...
            SL24_DC30.ForceCurrent(currentLevel: 1e-3, voltageLimit: 24); // force current on 1Kohm resistor

            // Connect LO_S of SLOT24 DC30's to DGS1 only, disconnect LO_s channels from DGS2/3/4
            ...
            HMODControl.CHMOD1to13(tsmContext, HMOD_Data_1: HMODControl.RelayID("K1")); // connect SL24 DGS1 to 1V reference
            ...
            // Connect LO_S of SLOT24 DC30's to DGS2 only, disconnect LO_s channels from DGS1/3/4
            ...
            HMODControl.CHMOD1to13(tsmContext, HMOD_Data_1: HMODControl.RelayID("K2")); // connect SL24 DGS2 to 2V reference
            Globals.TheHdw.Wait(SettlingTimeSec);

            SL24_DC30.Measure(out MeasDC30_SL24_DGS2, out _); // pin group measurement

            // Connect LO_S of SLOT24 DC30's to DGS3 only, disconnect LO_s channels from DGS1/2/4
            ...
            HMODControl.CHMOD1to13(tsmContext, HMOD_Data_1: HMODControl.RelayID("K3")); // connect SL24 DGS3 to 3V reference
            Globals.TheHdw.Wait(SettlingTimeSec);

            SL24_DC30.Measure(out MeasDC30_SL24_DGS3, out _); // pin group measurement

            // Connect LO_S of SLOT24 DC30's to DGS4 only, disconnect LO_s channels from DGS1/2/3
            ...
            HMODControl.CHMOD1to13(tsmContext, HMOD_Data_1: HMODControl.RelayID("K4")); // connect SL24 DGS4 to 4V reference
            Globals.TheHdw.Wait(SettlingTimeSec);

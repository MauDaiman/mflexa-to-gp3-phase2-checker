...
namespace TestSteps.Modules
{
    public class SL04_DC30_DGS_Check
    {
        ...
        public static void SL04DGSCheck(ISemiconductorModuleContext tsmContext)
        {
            ...
            SL04_DC30.ForceCurrent(currentLevel: 1e-3, voltageLimit: 24); // force current on 1Kohm resistor
            SL04_DC30.Initiate();
            ...
            HMODControl.CHMOD1to13(tsmContext, HMOD_Data_1: HMODControl.RelayID("K1")); // connect SL04 DGS1 to 1V reference
            ...
            HMODControl.CHMOD1to13(tsmContext, HMOD_Data_1: HMODControl.RelayID("K3")); // connect SL04 DGS3 to 3V reference
            Globals.TheHdw.Wait(SettlingTimeSec);
            ...
            HMODControl.CHMOD1to13(tsmContext, HMOD_Data_1: HMODControl.RelayID("K4")); // connect SL04 DGS4 to 4V reference
            Globals.TheHdw.Wait(SettlingTimeSec);
